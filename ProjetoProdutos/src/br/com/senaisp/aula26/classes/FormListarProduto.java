...
public class FormListarProduto extends JFrame {
	...
	private DefaultTableModel tbmMdProd;
	...
	public FormListarProduto() {
		...
		tbmMdProd = new DefaultTableModel(cabecalho, 0);

		tblProdutos = new JTable(tbmMdProd) {
			public Component prepareRenderer(TableCellRenderer renderer, int row, int column) {
				Component returnComp = super.prepareRenderer(renderer, row, column);
				Color alternateColor = new Color(0, 255, 0);
