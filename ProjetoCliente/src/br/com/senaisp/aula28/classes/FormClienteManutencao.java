...
public class FormClienteManutencao extends JFrame {
	...
	private int tipoOperacao; // 1 - criar, 2 - Selecionar, 3 - Alterar, 4 - Excluir
	...
	public FormClienteManutencao() {
		...
		fmtCodigo = new JFormattedTextField();
		...
		// Se esquecer isso, o Úsuario vai lembrar da sua arvore geneológica
	...
	public void setTipoOperacao(int tipoOperacao) {
		...
		case 4:
			...
			Date dtNasc;
			try {
				dtNasc = fmtDt.parse((String) tblMdCli.getValueAt(linhaSelecionada, 3));
